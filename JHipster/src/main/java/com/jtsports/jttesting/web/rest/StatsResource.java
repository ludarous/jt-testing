...
public class StatsResource {
    ...
    private final WorkoutService jTTestService;
    ...
    public StatsResource(WorkoutService jTTestService, UserService userService, PersonService personService, StatsService statsService) {
