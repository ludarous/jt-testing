 ...
 */
@Mapper(componentModel = "spring", uses = {WorkoutResultMapper.class, ActivityMapper.class, WorkoutMapper.class, EventMapper.class, PersonMapper.class})
public interface ActivityResultMapper extends EntityMapper<ActivityResultDTO, ActivityResult> {

    @Mapping(source = "workoutResult.id", target = "workoutResultId")
    ...
    @Mapping(source = "workoutResultId", target = "workoutResult")
