...
public class WorkoutDTO implements Serializable {
    ...
    private Set<WorkoutCategoryDTO> workoutCategories = new HashSet<>();
    ...
    public Set<WorkoutCategoryDTO> getWorkoutCategories() {
        return workoutCategories;
    }

    public void setWorkoutCategories(Set<WorkoutCategoryDTO> workoutCategories) {
