...
public class ActivityResultResource {
    ...
    @Timed
    public ResponseEntity<ActivityResultDTO> createActivityResult(@Valid @RequestBody ActivityResultDTO activityResultDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<ActivityResultDTO> updateActivityResult(@Valid @RequestBody ActivityResultDTO activityResultDTO) throws URISyntaxException {
