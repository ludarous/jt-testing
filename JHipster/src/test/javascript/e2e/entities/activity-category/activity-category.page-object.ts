...
export class ActivityCategoryComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-activity-category div table .btn-danger'));
...
export class ActivityCategoryDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-activityCategory-heading'));
    private confirmButton = element(by.id('jhi-confirm-delete-activityCategory'));
