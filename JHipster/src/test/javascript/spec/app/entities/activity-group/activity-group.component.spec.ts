...
import { ActivityGroupComponent } from 'app/entities/activity-group/activity-group.component';
import { ActivityGroupService } from 'app/entities/activity-group/activity-group.service';
...
describe('Component Tests', () => {
    describe('ActivityGroup Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.activityGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
