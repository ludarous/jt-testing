...
describe('Component Tests', () => {
    describe('EventResult Management Component', () => {
        let comp: EventResultComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EventResultComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.eventResults[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
