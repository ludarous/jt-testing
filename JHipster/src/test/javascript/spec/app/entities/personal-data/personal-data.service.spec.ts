...
describe('Service Tests', () => {
    describe('PersonalData Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PersonalDataService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/personal-data';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PersonalData', () => {
                service.create(new PersonalData(null)).subscribe(received => {
            ...
            it('should update a PersonalData', () => {
                service.update(new PersonalData(123)).subscribe(received => {
            ...
            it('should return a PersonalData', () => {
            ...
            it('should return a list of PersonalData', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PersonalData(123)]);
            });
