...
import { PersonalDataComponent } from 'app/entities/personal-data/personal-data.component';
...
describe('Component Tests', () => {
    describe('PersonalData Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.personalData[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
