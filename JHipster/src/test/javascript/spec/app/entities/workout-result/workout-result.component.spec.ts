...
describe('Component Tests', () => {
    describe('WorkoutResult Management Component', () => {
        let comp: WorkoutResultComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WorkoutResultComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.workoutResults[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
