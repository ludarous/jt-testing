...
describe('Service Tests', () => {
    describe('TestCategory Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TestCategoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/test-categories';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TestCategory', () => {
                service.create(new TestCategory(null)).subscribe(received => {
            ...
            it('should update a TestCategory', () => {
                service.update(new TestCategory(123)).subscribe(received => {
            ...
            it('should return a TestCategory', () => {
            ...
            it('should return a list of TestCategory', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new TestCategory(123)]);
            });
