...
import { TestCategoryComponent } from 'app/entities/test-category/test-category.component';
...
describe('Component Tests', () => {
    describe('TestCategory Management Component', () => {
        let comp: TestCategoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TestCategoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.testCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
