...
import { PersonGroupComponent } from 'app/entities/person-group/person-group.component';
...
describe('Component Tests', () => {
    describe('PersonGroup Management Component', () => {
        let comp: PersonGroupComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PersonGroupComponent, '')
                .compileComponents();
